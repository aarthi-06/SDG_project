...
const getAIImageStatusClass = (status) => {

if (status === "LIKELY_REAL") {

return "collector-ai-auth-status collector-ai-auth-status--real";
...
return "collector-ai-auth-status collector-ai-auth-status--suspicious";
...
return "collector-ai-auth-status collector-ai-auth-status--generated";

}


return "collector-ai-auth-status collector-ai-auth-status--unknown";

};


const formatAIImageStatus = (status) => {
...
evidence.fileType?.toLowerCase() === "image" ? (
...
evidence.aiImageDetection && (

<div className="collector-ai-auth-card">

<div className="collector-ai-auth-card__header">
...
className={getAIImageStatusClass(
...
<div className="collector-ai-auth-grid">
...
{typeof evidence.aiImageDetection

.aiGeneratedProbability ===

"number"

? `${evidence.aiImageDetection.aiGeneratedProbability}%`
...
? `${evidence.aiImageDetection.confidence}%`
...
{evidence.aiImageDetection.reason && (

<p className="collector-ai-auth-reason">
...
{evidence.aiImageDetection.error && (

<p className="collector-ai-auth-error">
